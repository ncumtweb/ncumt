...
{{--                    <h3 class="category-title">Search Results</h3>--}}
                    ...
                    <div class="d-md-flex post-entry-2 small-img">
                        <a href="single-post.html" class="me-4 thumbnail">
                            <img src="{{ asset('/assets/img/aboutus.jpg') }}" alt="" class="img-fluid">
                        </a>
                        <div>
                            <div class="post-meta" style="font-size: 100%;"><span class="date">中級山</span> <span class="mx-1">&bullet;</span>
                                <span>2024.07.20-21</span></div>
                            <h3><a href="single-post.html">北坑溪古道-日向到雪見</a></h3>
                            <p>預期隊費
                                <br>
                                隊伍難度
                            </p>
                            <div class="d-flex align-items-center author">
                                <div class="name">
                                    <h3 class="m-0 p-0"><strong>領隊：易靖程</strong></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-md-flex post-entry-2 small-img">
                        ...
                        <div>
                            ...
                            <h3><a href="single-post.html">17 Pictures of Medium Length Hair in Layers That Will Inspire
                                    Your New Haircut</a></h3>
                    ...
                    <div class="d-md-flex post-entry-2 small-img">
                        ...
                        <div>
                            <div class="post-meta"><span class="date">Business</span> <span class="mx-1">&bullet;</span>
                                <span>Jul 5th '22</span></div>
                            <h3><a href="single-post.html">The Best Homemade Masks for Face (keep the Pimples Away)</a>
                            </h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat
                                exercitationem magni voluptates dolore. Tenetur fugiat voluptates quas.</p>
                            <div class="d-flex align-items-center author">
                    ...
                    <div class="d-md-flex post-entry-2 small-img">
                        ...
                        <div>
                            <div class="post-meta"><span class="date">Business</span> <span class="mx-1">&bullet;</span>
                                <span>Jul 5th '22</span></div>
                            <h3><a href="single-post.html">9 Half-up/half-down Hairstyles for Long and Medium Hair</a>
                            </h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat
                                exercitationem magni voluptates dolore. Tenetur fugiat voluptates quas.</p>
                            <div class="d-flex align-items-center author">
...
{{--                        <ul class="nav nav-pills custom-tab-nav mb-4 justify-content-center" id="pills-tab" role="tablist">--}}
{{--                            <li class="nav-item" role="presentation">--}}
{{--                                <button class="nav-link active" id="pills-popular-tab" data-bs-toggle="pill"--}}
{{--                                        data-bs-target="#pills-popular" type="button" role="tab"--}}
{{--                                        aria-controls="pills-popular" aria-selected="true">Level--}}
{{--                                </button>--}}
{{--                            </li>--}}
{{--                            <!--                <li class="nav-item" role="presentation">-->--}}
...
{{--                                    <div class="post-meta"><span class="date">中級山</span> <span--}}
{{--                                            class="mx-1">&bullet;</span> <span>2024.07.20-21</span></div>--}}
{{--                                    <h2 class="mb-2"><a href="#">北坑溪古道-日向到雪見</a></h2>--}}
{{--                                    <span class="author mb-3 d-block">Ranking: ???</span>--}}
{{--                                </div>--}}
