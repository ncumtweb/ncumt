                    ...
                    <div class="col-md-8 mb-5">
                        <div class="form mt-5">
                            ...
                            <form action="{{ route('trip.update', ['id' => $trip->id]) }}" method="POST"
                                  id="createRecordForm" class="createRecordForm" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="date" class="form-control" id="registration_open"
                                               ...
                                               value="{{ old('registration_open', $trip->registration_open->format('Y-m-d')) }}"
                                               required>
                                    </div>
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="date" class="form-control" id="registration_close"
                                               ...
                                               value="{{ old('registration_close', $trip->registration_close->format('Y-m-d')) }}"
                                               required>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="quit_date">鳥隊期限</label>
                                        <input type="date" class="form-control" id="quit_date" name="quit_date"
                                               value="{{ old('quit_date', $trip->quit_date->format('Y-m-d')) }}"
                                               required>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="date" class="form-control" id="pre_departure_time"
                                               name="pre_departure_time"
                                               value="{{ old('pre_departure_time', $trip->pre_departure_time->format('Y-m-d')) }}"
                                               required>
                                    </div>
                                    <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="prepare_day" class="form-control" id="prepare_day"
                                           value={{ old('prepare_day', $trip->prepare_day ?? '') }} required>
                                </div>

                                <div class="form-group">
                                    <label for="quit_rule" class="form-label">鳥隊規定</label>
                                    <textarea class="form-control" id="quit_rule"
                                              name="quit_rule">{{ $trip->quit_rule }}</textarea>
                                </div>
                                <div class="form-group col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="expected_cadre_count" class="form-control"
                                               id="expected_cadre_count"
                                               value={{ old('expected_cadre_count', $trip->expected_cadre_count ?? '') }} required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="expected_member_count" class="form-control"
                                               ...
                                               value={{ old('expected_member_count', $trip->expected_member_count ?? '') }} required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="additional_content"
                                              name="additional_content">{{ $trip->additional_content }}</textarea>
                                </div>
