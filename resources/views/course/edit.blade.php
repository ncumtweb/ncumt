        ...
        <section id="contact" class="contact mb-5">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="form mt-5">
                            <form action="{{ route('course.update', $course->id) }}" method="POST" id="createRecordForm"
                                ...
                                <div class="form-group">
                                    ...
                                    <img class="img-fluid" id="preview_image" src="{{ asset($course->image) }}"
                                         alt="預覽封面"/>
